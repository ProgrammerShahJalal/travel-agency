    ...
    return (
        <div className='my-5 pb-5 bg-gray-100 w-full'>
            ...
            <div className='max-w-md mx-auto overflow-hidden md:max-w-2xl'>
                <div className='md:grid grid-cols-1 max-w-md overflow-hidden md:max-w-2xl gap-3 mx-auto'>
                    {
                        blogs.map(blog => <OnlyBlog key={blog._id} blog={blog}></OnlyBlog>)
                    }
                </div>
            </div>
